...
double SMC::Get_N(){return N;
};

double SMC::Get_e_meanpath(){ return e_meanpath;
};

double SMC::Get_h_meanpath(){ return h_meanpath;
};

double SMC::Get_q(){ return q;
};

double SMC::Get_e_Eth(){ return e_Eth;
};

double SMC::Get_h_Eth(){ return h_Eth;
};

double SMC::Get_hw(){return hw;
};

double SMC::Get_e_mass(){return e_mass;
};

double SMC::Get_h_mass(){return h_mass;
};

double SMC::Get_e_Cii(){return e_Cii;
};

double SMC::Get_h_Cii(){return h_Cii;
};

double SMC::Get_e_gamma(){return e_gamma;
};

double SMC::Get_h_gamma(){return h_gamma;
};

int SMC::Get_NUMPOINTS(){return NUMPOINTS;
};

double SMC::Get_hbar(){return hbar;
};

double SMC::Get_Emax(){return Emax;
};

double SMC::Get_Vbi(){return Vbi;
};
